...
!function (t, e) {
    ...
    const r = {
            ...
            e: 14,
            f: 15
        }, l = "0123456789ABCDEF", h = t => l[15 & t], c = t => l[(240 & t) >> 4] + l[15 & t],
        d = t => (240 & t) >> 4 == (15 & t);
    ...
    function C(t) {
        ...
        const n = D(+e[2]), o = +e[3] / 100, a = +e[4] / 100;
        return i = "hwb" === e[1] ? function (t, e, i) {
            return S(M, t, e, i)
        }(n, o, a) : "hsv" === e[1] ? function (t, e, i) {
            return S(w, t, e, i)
        }(n, o, a) : P(n, o, a), {r: i[0], g: i[1], b: i[2], a: s}
    }
    ...
    class F {
        ...
        hslString() {
            return this._valid ? function (t) {
                if (!t) return;
                const e = k(t), i = e[0], s = b(e[1]), n = b(e[2]);
    ...
    function J(t, e, i, s) {
        let n, o, a;
        if (Y(t)) if (o = t.length, s) for (n = o - 1; n >= 0; n--) e.call(i, t[n], n); else for (n = 0; n < o; n++) e.call(i, t[n], n); else if (U(t)) for (a = Object.keys(t), o = a.length, n = 0; n < o; n++) e.call(i, t[a[n]], a[n])
    }
    ...
    const ct = t => void 0 !== t, dt = t => "function" == typeof t, ut = (t, e) => {
    ...
    var xt = new class {
        ...
        route(t, e, i, s) {
            const n = pt(this, t), o = pt(this, i), a = "_" + e;
    ...
    const bt = Math.PI, _t = 2 * bt, yt = _t + bt, vt = Number.POSITIVE_INFINITY, wt = bt / 180, Mt = bt / 2,
        kt = bt / 4, St = 2 * bt / 3, Pt = Math.log10, Dt = Math.sign;

    function Ct(t) {
        const e = Math.round(t);
        t = Tt(t, e, t / 1e3) ? e : t;
        const i = Math.pow(10, Math.floor(Pt(t))), s = t / i;
    ...
    function Nt(t, e, i, s) {
        const n = Wt(t), o = Wt(e), a = Wt(i), r = Wt(o - n), l = Wt(a - n), h = Wt(n - o), c = Wt(n - a);
    ...
    function Xt(t, e, i, s) {
        ...
        const r = i.length;
        let l, h, c, d, u;
        for (l = 0; l < r; l++) if (d = i[l], null != d && !0 !== Y(d)) a = Ut(t, n, o, a, d); else if (Y(d)) for (h = 0, c = d.length; h < c; h++) u = d[h], null == u || Y(u) || (a = Ut(t, n, o, a, u));
        t.restore();
        const f = o.length / 2;
        if (f > i.length) {
    ...
    function ie(t, e, i, s, n, o = {}) {
        const a = Y(e) ? e : [e], r = o.strokeWidth > 0 && "" !== o.strokeColor;
        let l, h;
        ...
        }(t, o), l = 0; l < a.length; ++l) h = a[l], r && (o.strokeColor && (t.strokeStyle = o.strokeColor), $(o.strokeWidth) || (t.lineWidth = o.strokeWidth), t.strokeText(h, i, s, o.maxWidth)), t.fillText(h, i, s, o.maxWidth), se(t, i, s, h, o), s += n.lineHeight;
        t.restore()
    }
    ...
    const ae = (t, e, i) => oe(t, i, (s => t[s][e] < i)), re = (t, e, i) => oe(t, i, (s => t[s][e] >= i));
    ...
    function de(t, e) {
        ...
        -1 !== n && s.splice(n, 1), s.length > 0 || (he.forEach((e => {
            delete t[e]
        })), delete t._chartjs)
    }
    ...
    function ye(t, e) {
        const {canvas: i, currentDevicePixelRatio: s} = e, n = me(i), o = "border-box" === n.boxSizing,
            a = _e(n, "padding"), r = _e(n, "border", "width"), {x: l, y: h, box: c} = function (t, e) {
                ...
                let r, l, h = !1;
                if (((t, e, i) => (t > 0 || e > 0) && (!i || !i.shadowRoot))(o, a, i.target)) r = o, l = a; else {
    ...
    function we(t, e, i, s) {
        const n = me(t), o = _e(n, "margin"), a = pe(n.maxWidth, t, "clientWidth") || vt,
            r = pe(n.maxHeight, t, "clientHeight") || vt, l = function (t, e, i) {
                let s, n;
        ...
        return h = Math.max(0, h - o.width), c = Math.max(0, s ? Math.floor(h / s) : c - o.height), h = ve(Math.min(h, a, l.maxWidth)), c = ve(Math.min(c, r, l.maxHeight)), h && !c && (c = ve(h / 2)), {
            width: h,
            height: c
        }
    }
    ...
    function Ce(t, e, i, s, n) {
        ...
        for (let t = 0, i = o.length; t < i; ++t) {
            const {index: i, data: r} = o[t], {lo: l, hi: h} = De(o[t], e, a, n);
            for (let t = l; t <= h; ++t) {
                const e = r[t];
                e.skip || s(e, i, t)
            }
    ...
    function Oe(t, e, i, s) {
        ...
        return Ce(t, i, e, (function (t, i, o) {
            t.inRange(e.x, e.y, s) && n.push({element: t, datasetIndex: i, index: o})
        }), !0), n
    }
    ...
    function Ae(t, e, i, s, n) {
        ...
        return Ce(t, i, e, (function (i, l, h) {
            if (s && !i.inRange(e.x, e.y, n)) return;
            const c = i.getCenterPoint(n);
            if (!Zt(c, t.chartArea, t._minPadding) && !i.inRange(e.x, e.y, n)) return;
            const d = o(e, c);
            d < a ? (r = [{element: i, datasetIndex: l, index: h}], a = d) : d === a && r.push({
                element: i,
                datasetIndex: l,
                index: h
            })
    ...
    function Te(t, e, i, s) {
        const n = Pe(e, t), o = [], a = i.axis, r = "x" === a ? "inXRange" : "inYRange";
        let l = !1;
        return function (t, e) {
            ...
            t[r](n[a], s) && o.push({element: t, datasetIndex: e, index: i}), t.inRange(n.x, n.y, s) && (l = !0)
        })), i.intersect && !l ? [] : o
    }
    ...
    var Le = {
        modes: {
            index(t, e, i, s) {
                const n = Pe(e, t), o = i.axis || "x", a = i.intersect ? Oe(t, n, o, s) : Ae(t, n, o, !1, s), r = [];
            ...
            x: (t, e, i, s) => (i.axis = "x", Te(t, e, i, s)),
            y: (t, e, i, s) => (i.axis = "y", Te(t, e, i, s))
        }
    };
    const Re = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
        Ee = new RegExp(/^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/);
    ...
    function ze(t, e) {
        const i = {}, s = U(e), n = s ? Object.keys(e) : e, o = U(t) ? s ? i => K(t[i], t[e[i]]) : e => t[e] : () => t;
    ...
    function We(t, e) {
        ...
        s && !("" + s).match(Ee) && (console.warn('Invalid font style specified: "' + s + '"'), s = "");
        const n = {
    ...
    function He(t, e, i) {
        const {min: s, max: n} = t, o = Z(e, (n - s) / 2), a = (t, e) => i && 0 === t ? 0 : t + e;
    ...
    function Ze(t, e, i, s) {
        ...
        const r = Math.max(0, e.outerWidth - Ke(a, t, "left", "right")),
            l = Math.max(0, e.outerHeight - Ke(a, t, "top", "bottom")), h = r !== t.w, c = l !== t.h;
    ...
    function Je(t, e, i, s) {
        ...
        for (o = 0, a = t.length, h = 0; o < a; ++o) {
            r = t[o], l = r.box, l.update(r.width || e.w, r.height || e.h, Qe(r.horizontal, e));
    ...
    function ei(t, e, i, s) {
        ...
        for (const r of t) {
            ...
            if (r.horizontal) {
                ...
                ct(l.start) && (a = l.start), t.fullSize ? ti(t, n.left, a, i.outerWidth - n.right - n.left, o) : ti(t, e.left + l.placed, a, s, o), l.start = a, l.placed += s, a = t.bottom
            } else {
                const s = e.h * h, a = l.size || t.width;
                ct(l.start) && (o = l.start), t.fullSize ? ti(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : ti(t, o, e.top + l.placed, a, s), l.start = o, l.placed += s, o = t.right
            }
        }
        e.x = o, e.y = a
    }
    ...
    var ii = {
        addBox(t, e) {
            ...
            if (!t) return;
            const n = Ve(t.options.layout.padding), o = Math.max(e - n.width, 0), a = Math.max(i - n.height, 0),
                r = function (t) {
                    const e = function (t) {
                            const e = [];
                            let i, s, n, o, a, r;
                            ...
                            return e
                        }(t), i = Xe(e.filter((t => t.box.fullSize)), !0), s = Xe(Ye(e, "left"), !0),
                        n = Xe(Ye(e, "right")), o = Xe(Ye(e, "top"), !0), a = Xe(Ye(e, "bottom")), r = Ue(e, "x"),
                        l = Ue(e, "y");
                    return {
                        fullSize: i,
            ...
            Ge(u, Ve(s));
            const f = Object.assign({maxPadding: u, w: o, h: a, x: n.left, y: n.top}, n), g = qe(l.concat(h), d);
            Je(r.fullSize, f, d, g), Je(l, f, d, g), Je(h, f, d, g) && Je(l, f, d, g), function (t) {
            ...
            }(f), ei(r.leftAndTop, f, d, g), f.x += f.w, f.y += f.h, ei(r.rightAndBottom, f, d, g), t.chartArea = {
                left: f.left,
                top: f.top,
                right: f.left + f.w,
                bottom: f.top + f.h,
    ...
    function si(t, e = [""], i = t, s, n = (() => t[0])) {
        ...
        return new Proxy(o, {
            ...
            get: (i, s) => li(i, s, (() => function (t, e, i, s) {
                let n;
                for (const o of e) if (n = gi(ai(o, t), i), ct(n)) return ri(t, n) ? ui(i, s, t, n) : n
            }(s, e, t, i))),
    ...
    function ni(t, e, i, s) {
        ...
        return new Proxy(n, {
            ...
            get: (t, e, i) => li(t, e, (() => function (t, e, i) {
                ...
                dt(r) && a.isScriptable(e) && (r = function (t, e, i, s) {
                    ...
                    r.add(t), e = e(o, a || s), r.delete(t), ri(t, e) && (e = ui(n._scopes, n, t, e));
                    return e
                }(e, r, t, i));
    ...
    const ai = (t, e) => t ? t + ht(e) : e,
        ri = (t, e) => U(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
    ...
    const ci = (t, e) => !0 === t ? e : "string" == typeof t ? lt(e, t) : void 0;
    ...
    function ui(t, e, i, s) {
        const n = e._rootScopes, o = hi(e._fallback, i, s), a = [...t, ...n], r = new Set;
        r.add(s);
        let l = fi(r, a, i, o || i);
        return null !== l && ((!ct(o) || o === i || (l = fi(r, a, o, l), null !== l)) && si(Array.from(r), [""], n, o, (() => function (t, e, i) {
    ...
    const mi = Number.EPSILON || 1e-14, xi = (t, e) => e < t.length && !t[e].skip && t[e],
        bi = t => "x" === t ? "y" : "x";

    function _i(t, e, i, s) {
        const n = t.skip ? e : t, o = e, a = i.skip ? e : i, r = Bt(o, n), l = Bt(a, o);
        let h = r / (r + l), c = l / (r + l);
    ...
    function yi(t, e = "x") {
        const i = bi(e), s = t.length, n = Array(s).fill(0), o = Array(s);
        let a, r, l, h = xi(t, 0);
        for (a = 0; a < s; ++a) if (r = l, l = h, h = xi(t, a + 1), l) {
            if (h) {
                const t = h[e] - l[e];
                n[a] = 0 !== t ? (h[i] - l[i]) / t : 0
            }
        ...
        !function (t, e, i) {
            const s = t.length;
            let n, o, a, r, l, h = xi(t, 0);
            for (let c = 0; c < s - 1; ++c) l = h, h = xi(t, c + 1), l && h && (Tt(e[c], 0, mi) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
        }(t, n, o), function (t, e, i = "x") {
            const s = bi(i), n = t.length;
            let o, a, r, l = xi(t, 0);
            for (let h = 0; h < n; ++h) {
    ...
    function wi(t, e, i, s, n) {
        let o, a, r, l;
        if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) yi(t, n); else {
            let i = s ? t[t.length - 1] : t[0];
            for (o = 0, a = t.length; o < a; ++o) r = t[o], l = _i(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, i = r
        }
        e.capBezierPoints && function (t, e) {
            let i, s, n, o, a, r = Zt(t[0], e);
            for (i = 0, s = t.length; i < s; ++i) a = o, o = r, r = i < s - 1 && Zt(t[i + 1], e), o && (n = t[i], a && (n.cp1x = vi(n.cp1x, e.left, e.right), n.cp1y = vi(n.cp1y, e.top, e.bottom)), r && (n.cp2x = vi(n.cp2x, e.left, e.right), n.cp2y = vi(n.cp2y, e.top, e.bottom)))
        }(t, i)
    }

    const Mi = t => 0 === t || 1 === t, ki = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * _t / i),
        Si = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * _t / i) + 1, Pi = {
            linear: t => t,
            easeInQuad: t => t * t,
            easeOutQuad: t => -t * (t - 2),
            ...
            easeInOutExpo: t => Mi(t) ? t : t < .5 ? .5 * Math.pow(2, 10 * (2 * t - 1)) : .5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
            easeInCirc: t => t >= 1 ? t : -(Math.sqrt(1 - t * t) - 1),
            easeOutCirc: t => Math.sqrt(1 - (t -= 1) * t),
            easeInOutCirc: t => (t /= .5) < 1 ? -.5 * (Math.sqrt(1 - t * t) - 1) : .5 * (Math.sqrt(1 - (t -= 2) * t) + 1),
            easeInElastic: t => Mi(t) ? t : ki(t, .075, .3),
            easeOutElastic: t => Mi(t) ? t : Si(t, .075, .3),
            easeInOutElastic(t) {
                const e = .1125;
                return Mi(t) ? t : t < .5 ? .5 * ki(2 * t, e, .45) : .5 + .5 * Si(2 * t - 1, e, .45)
            },
            easeInBack(t) {
                const e = 1.70158;
                return t * t * ((e + 1) * t - e)
    ...
    function Oi(t, e, i, s) {
        const n = {x: t.cp2x, y: t.cp2y}, o = {x: e.cp1x, y: e.cp1y}, a = Di(t, n, i), r = Di(n, o, i), l = Di(o, e, i),
            h = Di(a, r, i), c = Di(r, l, i);
        return Di(h, c, i)
    }
    ...
    function Ii(t) {
        return "angle" === t ? {between: Nt, compare: Vt, normalize: Wt} : {
            between: $t,
            compare: (t, e) => t - e,
            normalize: t => t
        }
    ...
    function Fi(t, e, i) {
        ...
        const {property: s, start: n, end: o} = i,
            a = e.length, {compare: r, between: l, normalize: h} = Ii(s), {start: c, end: d, loop: u, style: f} = function (t, e, i) {
                const {property: s, start: n, end: o} = i, {between: a, normalize: r} = Ii(s), l = e.length;
        ...
        for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== x && (b = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(zi({
            start: _,
            end: t,
            loop: u,
            count: a,
        ...
        return null !== _ && g.push(zi({start: _, end: d, loop: u, count: a, style: f})), g
    }
    ...
    function Wi(t, e, i, s) {
        return s && s.setContext && i ? function (t, e, i, s) {
            const n = t._chart.getContext(), o = Ni(t.options), {_datasetIndex: a, options: {spanGaps: r}} = t,
                l = i.length, h = [];
            ...
            for (const t of e) {
                ...
                for (u = d + 1; u <= t.end; u++) {
                    ...
                    e = Ni(s.setContext(je(n, {
                        ...
                        p1DataIndex: u % l,
                        datasetIndex: a
                    }))), Hi(e, c) && f(d, u - 1, t.loop, c), o = r, c = e
                }
    ...
    function es() {
        ...
        t !== ts && (ts = t, Ji.forEach(((e, i) => {
            i.currentDevicePixelRatio !== t && e()
        })))
    }

    function is(t, i, s) {
        const n = t.canvas, o = n && ge(n);
        if (!o) return;
        const a = e(((t, e) => {
    ...
    function ns(t, i, s) {
        const n = t.canvas, o = e((e => {
            null !== t.ctx && s(function (t, e) {
                const i = Ui[t.type] || t.type, {x: s, y: n} = ye(t, e);
    ...
    class os extends $i {
        acquireContext(t, e) {
            ...
            return i && i.canvas === t ? (function (t, e) {
                ...
                }, i.display = i.display || "block", i.boxSizing = i.boxSizing || "border-box", Xi(n)) {
                    const e = Se(t, "width");
                    void 0 !== e && (t.width = e)
                }
                if (Xi(s)) if ("" === t.style.height) t.height = t.width / (e || 2); else {
                    const e = Se(t, "height");
                    void 0 !== e && (t.height = e)
                }
            }(t, e), i) : null
        ...
        addEventListener(t, e, i) {
            ...
            const s = t.$proxies || (t.$proxies = {}), n = {attach: Zi, detach: Qi, resize: is}[e] || ns;
            s[e] = n(t, e, i)
        }
        ...
        removeEventListener(t, e) {
            ...
            if (!s) return;
            ({attach: ss, detach: ss, resize: ss}[e] || Ki)(t, e, s), i[e] = void 0
        }
    ...
    function as(t) {
        return !fe() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? Yi : os
    }
    ...
    const ls = "transparent", hs = {
        boolean: (t, e, i) => i > .5 ? e : t, color(t, e, i) {
            const s = W(t || ls), n = s.valid && W(e || ls);
    ...
    class cs {
        constructor(t, e, i, s) {
            ...
            this._active = !0, this._fn = t.fn || hs[t.type || typeof o], this._easing = Pi[t.easing] || Pi.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = i, this._from = o, this._to = s, this._promises = void 0
        }
        ...
        update(t, e, i) {
            if (this._active) {
                ...
                this._start = i, this._duration = Math.floor(Math.max(o, t.duration)), this._total += n, this._loop = !!t.loop, this._to = Ne([t.to, e, s, t.from]), this._from = Ne([t.from, s, e])
            }
        }
    ...
    }), xt.describe("animations", {_fallback: "animation"}), xt.set("transitions", {
    ...
    function _s(t, e) {
        ...
        for (let t = 0; t < d; ++t) {
            ...
            u = (i._stacks || (i._stacks = {}))[h] = xs(n, c, o), u[r] = d, u._top = bs(u, a, !0, s.type), u._bottom = bs(u, a, !1, s.type)
        }
    }
    ...
    const ws = t => "reset" === t || "none" === t, Ms = (t, e) => e ? t : Object.assign({}, t);
    ...
    class ks {
        ...
        initialize() {
            ...
            this.configure(), this.linkScales(), t._stacked = ms(t.vScale, t), this.addElements()
        }
        ...
        linkScales() {
            const t = this.chart, e = this._cachedMeta, i = this.getDataset(),
                s = (t, e, i, s) => "x" === t ? e : "r" === t ? s : i, n = e.xAxisID = K(i.xAxisID, ys(t, "x")),
                o = e.yAxisID = K(i.yAxisID, ys(t, "y")), a = e.rAxisID = K(i.rAxisID, ys(t, "r")), r = e.indexAxis,
        ...
        _dataCheck() {
            ...
            if (U(e)) this._data = function (t) {
                ...
                e && Object.isExtensible(e) && ce(e, this), this._syncList = [], this._data = e
            }
        }
        ...
        buildOrUpdateElements(t) {
            ...
            this._dataCheck();
            const n = e._stacked;
            e._stacked = ms(e.vScale, e), e.stack !== i.stack && (s = !0, vs(e), e.stack = i.stack), this._resyncElements(t), (s || n !== e._stacked) && _s(this, e._parsed)
        }
        ...
        applyStack(t, e, i) {
            ...
            return ps({keys: gs(s, !0), values: e._stacks[t.axis]}, o, n.index, {mode: i})
        }
        ...
        updateRangeFromParsed(t, e, i, s) {
            ...
            s && a && (s.values = a, o = ps(s, n, this._cachedMeta.index)), t.min = Math.min(t.min, o), t.max = Math.max(t.max, o)
        }

        getMinMax(t, e) {
            const i = this._cachedMeta, s = i._parsed, n = i._sorted && t === i.iScale, o = s.length,
                a = this._getOtherScale(t),
                r = ((t, e, i) => t && !e.hidden && e._stacked && {keys: gs(i, !0), values: null})(e, i, this.chart),
        ...
        getContext(t, e, i) {
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                return je(t, {active: !1, dataset: void 0, datasetIndex: e, index: e, mode: "default", type: "dataset"})
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            const l = this.chart.config, h = l.datasetElementScopeKeys(this._type, t),
                ...
                u = Object.keys(xt.elements[t]), f = l.resolveNamedOptions(d, u, (() => this.getContext(i, s)), c);
            return f.$shared && (f.$shared = r, n[o] = Object.freeze(Ms(f, r))), f
        }
    ...
    ks.defaults = {}, ks.prototype.datasetElementType = null, ks.prototype.dataElementType = null;
    ...
    const Ps = {
        values: t => Y(t) ? t : "" + t, numeric(t, e, i) {
            ...
            return 1 === s || 2 === s || 5 === s ? Ps.numeric.call(this, t, e, i) : ""
        }
    };
    ...
    function Cs(t, e) {
        ...
        if (o > 0) {
            ...
            for (Os(e, l, h, $(s) ? 0 : a - s, a), t = 0, i = o - 1; t < i; t++) Os(e, l, h, n[t], n[t + 1]);
    ...
    function Os(t, e, i, s, n) {
        const o = K(s, 0), a = Math.min(K(n, t.length), t.length);
        let r, l, h, c = 0;
    ...
    }), xt.describe("scales", {_fallback: "scale"}), xt.describe("scale.ticks", {
    ...
    function Es(t, e) {
        ...
        const i = We(t.font, e), s = Ve(t.padding);
    ...
    class zs extends Ss {
        ...
        getMinMax(t) {
            ...
            return i = o && i > s ? s : i, s = n && i > s ? i : s, {min: q(i, q(s, i)), max: q(s, q(i, s))}
        }
        ...
        update(t, e, i) {
            ...
            this.beforeUpdate(), this.maxWidth = t, this.maxHeight = e, this._margins = i = Object.assign({
                ...
                top: 0,
                bottom: 0
            }, i), this.ticks = null, this._labelSizes = null, this._gridLineItems = null, this._labelItems = null, this.beforeSetDimensions(), this.setDimensions(), this.afterSetDimensions(), this._maxLength = this.isHorizontal() ? this.width + i.left + i.right : this.height + i.top + i.bottom, this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), this._range = He(this, n, s), this._dataLimitsCached = !0), this.beforeBuildTicks(), this.ticks = this.buildTicks() || [], this.afterBuildTicks();
            const r = a < this.ticks.length;
            this._convertTicksToLabels(r ? Ts(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Cs(this, this.ticks), this._labelSizes = null), r && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate()
        }
        ...
        calculateLabelRotation() {
            ...
            o = t.offset ? this.maxWidth / i : u / (i - 1), c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - Rs(t.grid) - e.padding - Es(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = It(Math.min(Math.asin(Ht((h.highest.height + 6) / o, -1, 1)), Math.asin(Ht(a / r, -1, 1)) - Math.asin(Ht(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))), this.labelRotation = l
        }
            ...
            if (o) {
                ...
                if (a ? (t.width = this.maxWidth, t.height = Rs(n) + o) : (t.height = this.maxHeight, t.width = Rs(n) + o), i.display && this.ticks.length) {
                    const {first: e, last: s, widest: n, highest: o} = this._getLabelSizes(), r = 2 * i.padding,
                        l = Et(this.labelRotation), h = Math.cos(l), c = Math.sin(l);
                    if (a) {
        ...
        _getLabelSizes() {
            ...
            if (!t) {
                ...
                let i = this.ticks;
                e < i.length && (i = Ts(i, e)), this._labelSizes = t = this._computeLabelSizes(i, i.length)
            }
            return t
        }
        ...
        _computeLabelSizes(t, e) {
            ...
            for (a = 0; a < e; ++a) {
                if (h = t[a].label, c = this._resolveTickFontOptions(a), i.font = d = c.string, u = s[d] = s[d] || {
                    ...
                    if (Y(h)) for (r = 0, l = h.length; r < l; ++r) m = h[r], $(m) || Y(m) || (g = Ut(i, u.data, u.gc, g, m), p += f)
            ...
            const _ = n.indexOf(x), y = o.indexOf(b), v = t => ({width: n[t] || 0, height: o[t] || 0});
        ...
        getContext(t) {
            ...
            return this.$context || (this.$context = je(this.chart.getContext(), {scale: this, type: "scale"}))
        }

        _tickSize() {
            const t = this.options.ticks, e = Et(this.labelRotation), i = Math.abs(Math.cos(e)),
        ...
        _computeGridLineItems(t) {
            const e = this.axis, i = this.chart, s = this.options, {grid: n, position: o} = s, a = n.offset,
                r = this.isHorizontal(), l = this.ticks.length + (a ? 1 : 0), h = Rs(n), c = [],
            ...
            const D = K(s.ticks.maxTicksLimit, l), C = Math.max(1, Math.ceil(l / D));
            for (m = 0; m < l; m += C) {
                ...
                x = Ls(this, m, a), void 0 !== x && (b = qt(i, x, e), r ? _ = v = M = S = b : y = w = k = P = b, c.push({
                    tx1: _,
                    ty1: y,
                    tx2: v,
                    ty2: w,
        ...
        _computeLabelItems(t) {
            const e = this.axis, i = this.options, {position: s, ticks: n} = i, o = this.isHorizontal(),
                a = this.ticks, {align: r, crossAlign: l, padding: h, mirror: c} = n, d = Rs(i.grid), u = d + h,
                f = c ? -h : u, g = -Et(this.labelRotation), p = [];
            ...
            for (m = 0, x = a.length; m < x; ++m) {
                ...
                if (o ? (y = M, D = "top" === s ? "near" === l || 0 !== g ? -P * S + S / 2 : "center" === l ? -O.highest.height / 2 - e * S + S : -O.highest.height + S / 2 : "near" === l || 0 !== g ? S / 2 : "center" === l ? O.highest.height / 2 - e * S : O.highest.height - P * S, c && (D *= -1)) : (v = M, D = (1 - P) * S / 2), t.showLabelBackdrop) {
                    const e = Ve(t.backdropPadding), i = O.heights[m], s = O.widths[m];
        ...
        drawLabels(t) {
            ...
            for (n = 0, o = s.length; n < o; ++n) {
                ...
                t.backdrop && (e.fillStyle = t.backdrop.color, e.fillRect(t.backdrop.left, t.backdrop.top, t.backdrop.width, t.backdrop.height)), ie(e, o, 0, t.textOffset, i, t)
            }
            i && Jt(e)
        }
        ...
        drawTitle() {
            ...
            if (!i.display) return;
            const o = We(i.font), a = Ve(i.padding), r = i.align;
            ...
            const {titleX: h, titleY: c, maxWidth: d, rotation: u} = function (t, e, i, s) {
                ...
                if (t.isHorizontal()) {
                    ...
                    } else g = "center" === i ? (c.bottom + c.top) / 2 + m - e : As(t, i, e);
                    u = l - a
                } else {
                    if (U(i)) {
                        const t = Object.keys(i)[0], s = i[t];
                        f = d[t].getPixelForValue(s) - x + e
                    } else f = "center" === i ? (c.left + c.right) / 2 - x + e : As(t, i, e);
        ...
        _layers() {
            const t = this.options, e = t.ticks && t.ticks.z || 0, i = K(t.grid && t.grid.z, -1);
    ...
    var Bs = new class {
        constructor() {
            this.controllers = new Fs(ks, "datasets", !0), this.elements = new Fs(Ss, "elements"), this.plugins = new Fs(Object, "plugins"), this.scales = new Fs(zs, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
        }
    ...
    class Vs {
        ...
        _createDescriptors(t, e) {
            const i = t && t.config, s = K(i.options && i.options.plugins, {}), n = function (t) {
                const e = [], i = Object.keys(Bs.plugins.items);
            ...
            return !1 !== s || e ? function (t, e, i, s) {
                ...
                for (let a = 0; a < e.length; a++) {
                    const r = e[a], l = Ws(i[r.id], s);
                    null !== l && n.push({plugin: r, options: Ns(t.config, r, l, o)})
                }
                return n
            }(t, n, s, e) : []
        }
    ...
    function $s(t) {
        ...
        e.plugins = K(e.plugins, {}), e.scales = function (t, e) {
            const i = ft[t.type] || {scales: {}}, s = e.scales || {}, n = Hs(t.type, e), o = Object.create(null),
            ...
            return Object.keys(s).forEach((t => {
                ...
                const r = js(t, e), l = function (t, e) {
                    return t === e ? "_index_" : "_value_"
                }(r, n), h = i.scales || {};
                o[r] = o[r] || t, a[t] = ot(Object.create(null), [{axis: r}, e, h[r], h[l]])
            })), t.data.datasets.forEach((i => {
                const n = i.type || t.type, r = i.indexAxis || Hs(n, e), l = (ft[n] || {}).scales || {};
    ...
    class Gs {
        ...
        getOptionScopes(t, e, i) {
            ...
            const r = new Set;
            e.forEach((e => {
                t && (r.add(t), e.forEach((e => Ks(r, t, e)))), e.forEach((t => Ks(r, s, t))), e.forEach((t => Ks(r, ft[n] || {}, t))), e.forEach((t => Ks(r, xt, t))), e.forEach((t => Ks(r, gt, t)))
            }));
            const l = Array.from(r);
            return 0 === l.length && l.push(Object.create(null)), Xs.has(e) && o.set(e, l), l
        }
        ...
        resolveNamedOptions(t, e, i, s = [""]) {
            const n = {$shared: !0}, {resolver: o, subPrefixes: a} = Zs(this._resolverCache, t, s);
            let r = o;
            if (function (t, e) {
    ...
    function Zs(t, e, i) {
        ...
        let o = s.get(n);
        if (!o) {
            o = {resolver: si(e, i), subPrefixes: i.filter((t => !t.toLowerCase().includes("hover")))}, s.set(n, o)
        }
        return o
    }

    const Qs = t => U(t) && Object.getOwnPropertyNames(t).reduce(((e, i) => e || dt(t[i])), !1);
    ...
    const an = {}, rn = t => {
        const e = on(t);
        return Object.values(an).filter((t => t.canvas === e)).pop()
    };
    ...
    class hn {
        constructor(t, e) {
            const s = this.config = new Gs(e), n = on(t), o = rn(n);
        ...
        _resize(t, e) {
            ...
            this.width = o.width, this.height = o.height, this._aspectRatio = this.aspectRatio, Me(this, a, !0) && (this.notifyPlugins("resize", {size: o}), Q(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render())
        }
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                const i = e[t], s = js(t, i), n = "r" === s, o = "x" === s;
                return {
                    options: i,
                ...
                const n = e.options, o = n.id, a = js(o, n), r = K(n.type, e.dtype);
                void 0 !== n.position && tn(n.position, a) === tn(e.dposition) || (n.position = e.dposition), s[o] = !0;
                let l = null;
                if (o in i && i[o].type === r) l = i[o]; else {
                    l = new (Bs.getScale(r))({id: o, type: r, ctx: this.ctx, chart: this}), i[l.id] = l
                }
                l.init(n, t)
            })), J(s, ((t, e) => {
                t || delete i[e]
        ...
        buildOrUpdateControllers() {
            ...
            for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                ...
                if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || Hs(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales(); else {
                    const e = Bs.getController(o), {datasetElementType: s, dataElementType: a} = xt.datasets[o];
        ...
        update(t) {
            ...
            o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || J(n, (t => {
                t.reset()
            })), this._updateDatasets(t), this.notifyPlugins("afterUpdate", {mode: t}), this._layers.sort(en("z", "_idx")), this._lastEvent && this._eventHandler(this._lastEvent, !0), this.render()
        }
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {cancelable: !0}) && (a.has(this) ? this.attached && !a.running(this) && a.start(this) : (this.draw(), sn({chart: this})))
        }
        ...
        _drawDataset(t) {
            ...
            }), t.controller.draw(), s && Jt(e), o.cancelable = !1, this.notifyPlugins("afterDatasetDraw", o))
        }
        ...
        getContext() {
            return this.$context || (this.$context = je(null, {chart: this, type: "chart"}))
        }
        ...
        destroy() {
            ...
            this._stop(), this.config.clearCache(), t && (this.unbindEvents(), Kt(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), this.notifyPlugins("destroy"), delete an[this.id]
        }
        ...
        _handleEvent(t, e) {
            ...
            let a = [], r = !1, l = null;
            return "mouseout" !== t.type && (a = this.getElementsAtEventForMode(t, n.mode, n, o), l = "click" === t.type ? this._lastEvent : t), this._lastEvent = null, Zt(t, this.chartArea, this._minPadding) && (Q(s.onHover, [t, a, this], this), "mouseup" !== t.type && "click" !== t.type && "contextmenu" !== t.type || Q(s.onClick, [t, a, this], this)), r = !tt(a, i), (r || e) && (this._active = a, this._updateHoverStyles(a, i, e)), this._lastEvent = l, r
        }
    }

    const cn = () => J(hn.instances, (t => t._plugins.invalidate())), dn = !0;
    ...
    Object.defineProperties(hn, {
        ...
        version: {enumerable: dn, value: "3.6.1"},
        getChart: {enumerable: dn, value: rn},
        register: {
            enumerable: dn, value: (...t) => {
                Bs.add(...t), cn()
            }
        },
        unregister: {
    ...
    function xn(t, e, i, s) {
        ...
        let h, c, d, u;
        for (h = i, c = i + s; h < c; ++h) u = e[h], d = {}, d[n.axis] = r || n.parse(a[h], h), l.push(mn(u, d, o, h));
        return l
    }
    ...
    function _n(t, e, i, s) {
        ...
        "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[yn(c, a, r, l)] = !0, n = h)), o[yn(n, a, r, l)] = !0, t.borderSkipped = o
    }

    function yn(t, e, i, s) {
        var n, o, a;
        return s ? (a = i, t = vn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = vn(t, e, i), t
    }
    ...
    class Mn extends ks {
        ...
        parseObjectData(t, e, i, s) {
            ...
            let d, u, f, g;
            for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(lt(g, l), d), c.push(mn(lt(g, h), f, o, d));
            return c
        }
        ...
        updateElements(t, e, i, s) {
            const n = "reset" === s, {index: o, _cachedMeta: {vScale: a}} = this, r = a.getBasePixel(),
                l = a.isHorizontal(), h = this._getRuler(), c = this.resolveDataElementOptions(e, s),
            ...
            for (let c = e; c < e + i; c++) {
                const e = this.getParsed(c),
                    ...
                    f = this._calculateBarIndexPixels(c, h), g = (e._stacks || {})[a.axis], p = {
                        horizontal: l,
                        base: i.base,
                        enableBorderRadius: !g || bn(e._custom) || o === g._top || o === g._bottom,
                        x: l ? i.head : f.center,
                        y: l ? f.center : i.head,
        ...
        _calculateBarValuePixels(t) {
            const {_cachedMeta: {vScale: e, _stacked: i}, options: {base: s, minBarLength: n}} = this, o = s || 0,
                a = this.getParsed(t), r = a._custom, l = bn(r);
        ...
        _calculateBarIndexPixels(t, e) {
            const i = e.scale, s = this.options, n = s.skipNull, o = K(s.maxBarThickness, 1 / 0);
            let a, r;
            if (e.grouped) {
    ...
    class kn extends ks {
        ...
        updateElements(t, e, i, s) {
            const n = "reset" === s, {iScale: o, vScale: a} = this._cachedMeta,
                r = this.resolveDataElementOptions(e, s), l = this.getSharedOptions(r), h = this.includeOptions(s, l),
                c = o.axis, d = a.axis;
            for (let r = e; r < e + i; r++) {
                const e = t[r], i = !n && this.getParsed(r), l = {},
    ...
    class Sn extends ks {
        ...
        update(t) {
            const e = this.chart, {chartArea: i} = e, s = this._cachedMeta, n = s.data,
                ...
                a = Math.max((Math.min(i.width, i.height) - o) / 2, 0), r = Math.min(G(this.options.cutout, a), 1),
                l = this._getRingWeight(this.index), {circumference: h, rotation: c} = this._getRotationExtents(), {ratioX: d, ratioY: u, offsetX: f, offsetY: g} = function (t, e, i) {
                    let s = 1, n = 1, o = 0, a = 0;
                    if (e < _t) {
                        const r = t, l = r + e, h = Math.cos(r), c = Math.sin(r), d = Math.cos(l), u = Math.sin(l),
                            f = (t, e, s) => Nt(t, r, l, !0) ? 1 : Math.max(e, e * i, s, s * i),
                            g = (t, e, s) => Nt(t, r, l, !0) ? -1 : Math.min(e, e * i, s, s * i), p = f(0, h, d),
                            m = f(Mt, c, u), x = g(bt, h, d), b = g(bt + Mt, c, u);
                        s = (p - x) / 2, n = (m - b) / 2, o = -(p + x) / 2, a = -(m + b) / 2
                    }
                    return {ratioX: s, ratioY: n, offsetX: o, offsetY: a}
                }(c, h, r), p = (i.width - o) / d, m = (i.height - o) / u, x = Math.max(Math.min(p, m) / 2, 0),
                b = Z(this.options.radius, x), _ = (b - Math.max(b * r, 0)) / this._getVisibleDatasetWeightTotal();
        ...
        getLabelAndValue(t) {
            const e = this._cachedMeta, i = this.chart, s = i.data.labels || [], n = Ti(e._parsed[t], i.options.locale);
    ...
    class Pn extends ks {
            ...
            let {start: a, count: r} = function (t, e, i) {
                ...
                if (t._sorted) {
                    const {iScale: a, _parsed: r} = t,
                        l = a.axis, {min: h, max: c, minDefined: d, maxDefined: u} = a.getUserBounds();
                    d && (n = Ht(Math.min(ae(r, a.axis, h).lo, i ? s : ae(e, l, a.getPixelForValue(h)).lo), 0, s - 1)), o = u ? Ht(Math.max(ae(r, a.axis, c).hi + 1, i ? 0 : ae(e, l, a.getPixelForValue(c)).hi + 1), n, s) - n : s - n
                }
        ...
        updateElements(t, e, i, s) {
            const n = "reset" === s, {iScale: o, vScale: a, _stacked: r, _dataset: l} = this._cachedMeta,
                h = this.resolveDataElementOptions(e, s), c = this.getSharedOptions(h), d = this.includeOptions(s, c),
                u = o.axis, f = a.axis, {spanGaps: g, segment: p} = this.options,
                m = At(g) ? g : Number.POSITIVE_INFINITY, x = this.chart._animationsDisabled || n || "none" === s;
            let b = e > 0 && this.getParsed(e - 1);
            for (let h = e; h < e + i; ++h) {
                const e = t[h], i = this.getParsed(h), g = x ? e : {}, _ = $(i[f]),
    ...
    Pn.id = "line", Pn.defaults = {
        ...
        showLine: !0,
        spanGaps: !1
    }, Pn.overrides = {scales: {_index_: {type: "category"}, _value_: {type: "linear"}}};
    ...
    class Dn extends ks {
        ...
        updateElements(t, e, i, s) {
            const n = "reset" === s, o = this.chart, a = this.getDataset(), r = o.options.animation,
                l = this._cachedMeta.rScale, h = l.xCenter, c = l.yCenter, d = l.getIndexAngle(0) - .5 * bt;
            let u, f = d;
            const g = 360 / this.countVisibleElements();
            for (u = 0; u < e; ++u) f += this._computeAngle(u, s, g);
            for (u = e; u < e + i; u++) {
                const e = t[u];
                let i = f, p = f + this._computeAngle(u, s, g),
    ...
    Cn.id = "pie", Cn.defaults = {cutout: 0, rotation: 0, circumference: 360, radius: "100%"};
        ...
        updateElements(t, e, i, s) {
            ...
            for (let r = e; r < e + i; r++) {
                const e = t[r], i = this.resolveDataElementOptions(r, e.active ? "active" : s),
                    l = o.getPointPositionForValue(r, n.data[r]), h = a ? o.xCenter : l.x, c = a ? o.yCenter : l.y,
    ...
    On.id = "radar", On.defaults = {
        datasetElementType: "line",
        dataElementType: "point",
        indexAxis: "r",
        showLine: !0,
        elements: {line: {fill: "start"}}
    }, On.overrides = {aspectRatio: 1, scales: {r: {type: "radialLinear"}}};

    class An extends Pn {
    }

    An.id = "scatter", An.defaults = {showLine: !1, fill: !1}, An.overrides = {
    ...
    function Rn(t, e, i, s) {
        const n = ze(t.options.borderRadius, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
    ...
    function In(t, e, i, s, n) {
        ...
        const g = (f - Math.max(.001, f * c - i / bt) / c) / 2, p = r + g + u,
            m = n - g - u, {outerStart: x, outerEnd: b, innerStart: _, innerEnd: y} = Rn(e, d, c, m - p), v = c - x,
            w = c - b, M = p + x / v, k = m - b / w, S = d + _, P = d + y, D = p + _ / S, C = m - y / P;
    ...
    function zn(t, e, i, s, n) {
        ...
        o.borderWidth && (a ? (t.lineWidth = 2 * o.borderWidth, t.lineJoin = "round") : (t.lineWidth = o.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function (t, e, i) {
            const {x: s, y: n, startAngle: o, pixelMargin: a, fullCircles: r} = e, l = Math.max(e.outerRadius - a, 0),
                h = e.innerRadius + a;
            let c;
            for (i && Ln(t, e, o + _t), t.beginPath(), t.arc(s, n, h, o + _t, o, !0), c = 0; c < r; ++c) t.stroke();
            for (t.beginPath(), t.arc(s, n, l, o, o + _t), c = 0; c < r; ++c) t.stroke()
        }(t, e, a), a && Ln(t, e, n), In(t, e, i, s, n), t.stroke())
    }
    ...
    class Fn extends Ss {
        ...
        inRange(t, e, i) {
            const s = this.getProps(["x", "y"], i), {angle: n, distance: o} = Ft(s, {
                    x: t,
                    y: e
                ...
                d = this.options.spacing / 2, u = K(c, r - a) >= _t || Nt(n, a, r), f = $t(o, l + d, h + d);
            return u && f
        }

        getCenterPoint(t) {
            const {x: e, y: i, startAngle: s, endAngle: n, innerRadius: o, outerRadius: a} = this.getProps(["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius", "circumference"], t), {offset: r, spacing: l} = this.options,
                h = (s + n) / 2, c = (o + a + l + r) / 2;
    ...
    function Nn(t, e, i, s) {
        const {points: n, options: o} = e, {count: a, start: r, loop: l, ilen: h} = Wn(n, i, s), c = function (t) {
            return t.stepped ? te : t.tension || "monotone" === t.cubicInterpolationMode ? ee : Vn
        }(o);
    ...
    function Hn(t, e, i, s) {
        const n = e.points, {count: o, start: a, ilen: r} = Wn(n, i, s), {move: l = !0, reverse: h} = s || {};
    ...
    function jn(t) {
        ...
        return !(t._decimated || t._loop || e.tension || "monotone" === e.cubicInterpolationMode || e.stepped || i) ? Hn : Nn
    }
    ...
    function Yn(t, e, i, s) {
        $n && !e.options.segment ? function (t, e, i, s) {
            let n = e._path;
            n || (n = e._path = new Path2D, e.path(n, i, s) && n.closePath()), Bn(t, e.options), t.stroke(n)
        }(t, e, i, s) : function (t, e, i, s) {
            const {segments: n, options: o} = e, a = jn(e);
            for (const r of n) Bn(t, o, r.style), t.beginPath(), a(t, e, r, {
                start: i,
                end: i + s - 1
    ...
    class Un extends Ss {
        ...
        get segments() {
            return this._segments || (this._segments = Vi(this, this.options.segment))
        }
        ...
        interpolate(t, e) {
            const i = this.options, s = t[e], n = this.points, o = Bi(this, {property: e, start: s, end: s});
            if (!o.length) return;
            const a = [], r = function (t) {
                return t.stepped ? Ci : t.tension || "monotone" === t.cubicInterpolationMode ? Oi : Di
            }(i);
            let l, h;
        ...
        path(t, e, i) {
            const s = this.segments, n = jn(this);
            let o = this._loop;
        ...
        draw(t, e, i, s) {
            ...
            (this.points || []).length && n.borderWidth && (t.save(), Yn(t, this, i, s), t.restore()), this.animated && (this._pointsUpdated = !1, this._path = void 0)
        }
    }
    ...
    }, Un.descriptors = {_scriptable: !0, _indexable: t => "borderDash" !== t && "fill" !== t};
    ...
    class qn extends Ss {
        ...
        draw(t, e) {
            const i = this.options;
            this.skip || i.radius < .1 || !Zt(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor, t.lineWidth = i.borderWidth, t.fillStyle = i.backgroundColor, Gt(t, i, this.x, this.y))
        }
    ...
    function Zn(t) {
        const e = Kn(t), i = e.right - e.left, s = e.bottom - e.top, n = function (t, e, i) {
            const s = t.options.borderWidth, n = t.borderSkipped, o = Fe(s);
            return {
            ...
            const {enableBorderRadius: s} = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, o = Be(n),
                a = Math.min(e, i), r = t.borderSkipped, l = s || U(n);
            return {
    ...
    class eo extends Ss {
        ...
        draw(t) {
            const {inflateAmount: e, options: {borderColor: i, backgroundColor: s}} = this, {inner: n, outer: o} = Zn(this),
                a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? ne : Jn;
            var r;
            t.save(), o.w === n.w && o.h === n.h || (t.beginPath(), a(t, to(o, e, n)), t.clip(), a(t, to(n, -e, o)), t.fillStyle = i, t.fill("evenodd")), t.beginPath(), a(t, to(n, e)), t.fillStyle = s, t.fill(), t.restore()
        }
    ...
    eo.id = "bar", eo.defaults = {
        ...
        inflateAmount: "auto",
        pointStyle: void 0
    }, eo.defaultRoutes = {backgroundColor: "backgroundColor", borderColor: "borderColor"};
    var io = Object.freeze({__proto__: null, ArcElement: Fn, LineElement: Un, PointElement: qn, BarElement: eo});
        ...
        id: "decimation", defaults: {algorithm: "min-max", enabled: !1}, beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach(((e, n) => {
                ...
                let {start: c, count: d} = function (t, e) {
                    ...
                    return l && (n = Ht(ae(e, o.axis, a).lo, 0, i - 1)), s = h ? Ht(ae(e, o.axis, r).hi + 1, n, i) - n : i - n, {
                        start: n,
                        count: s
                    }
                }(r, l);
                        ...
                        u = function (t, e, i, s, n) {
                            ...
                            for (a[l++] = t[p], c = 0; c < o - 2; c++) {
                                ...
                                const h = Math.floor((c + 1) * r) + 1 + e,
                                    m = Math.min(Math.floor((c + 2) * r) + 1, i) + e, x = m - h;
    ...
    class ro {
        ...
        pathSegment(t, e, i) {
            ...
            return e = e || {start: 0, end: _t}, t.arc(s, n, o, e.end, e.start, !0), !i.bounds
        }
    ...
    function lo(t) {
        return (t.scale || {}).getPointPositionForValue ? function (t) {
            const {scale: e, fill: i} = t, s = e.options, n = e.getLabels().length, o = [],
                a = s.reverse ? e.max : e.min, r = s.reverse ? e.min : e.max;
            let l, h, c;
            if (c = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue(), s.grid.circular) return h = e.getPointPositionForValue(0, a), new ro({
                x: h.x,
                y: h.y,
    ...
    function co(t, e, i) {
        ...
        for (let n = 0; n < i.length; n++) {
            const o = i[n], {first: a, last: r, point: l} = uo(o, e, "x");
    ...
    function go(t, e) {
        ...
        }(t, e), i.length ? new Un({points: i, options: {tension: 0}, _loop: s, _fullLoop: s}) : null
    }
    ...
    function vo(t, e) {
        const {line: i, target: s, property: n, color: o, scale: a} = e, r = function (t, e, i) {
            ...
            for (const t of s) {
                ...
                const h = Bi(e, l);
                for (const e of h) {
                    const s = xo(i, o[e.start], o[e.end], e.loop), r = Fi(t, n, s);
    ...
    function wo(t, e, i) {
        const s = fo(e), {line: n, scale: o, axis: a} = e, r = n.options, l = r.fill,
        ...
        s && n.points.length && (Qt(t, i), function (t, e) {
            ...
            t.save(), "x" === l && o !== n && (mo(t, s, a.top), vo(t, {
                line: i,
                target: s,
                color: n,
                scale: r,
                property: l
            }), t.restore(), t.save(), mo(t, s, a.bottom)), vo(t, {
                line: i,
                target: s,
                color: o,
                scale: r,
        ...
        }(t, {line: n, target: s, above: c, below: d, area: i, scale: o, axis: a}), Jt(t))
    }
    ...
    var Mo = {
        id: "filler", afterDatasetsUpdate(t, e, i) {
            ...
            let o, a, r, l;
            for (a = 0; a < s; ++a) o = t.getDatasetMeta(a), r = o.dataset, l = null, r && r.options && r instanceof Un && (l = {
            ...
            s && !1 !== s.fill && "beforeDatasetDraw" === i.drawTime && wo(t.ctx, s, t.chartArea)
    ...
    class So extends Ss {
        ...
        fit() {
            ...
            const i = t.labels, s = We(i.font), n = s.size,
                o = this._computeTitleHeight(), {boxWidth: a, itemHeight: r} = ko(i, n);
            let l, h;
        ...
        adjustHitBoxes() {
            ...
            const t = this._computeTitleHeight(), {legendHitBoxes: e, options: {align: i, labels: {padding: s}, rtl: o}} = this,
        ...
        _draw() {
            const {options: t, columnSizes: e, lineWidths: i, ctx: s} = this, {align: a, labels: r} = t, l = xt.color,
                h = Li(t.rtl, this.left, this.width), c = We(r.font), {color: d, padding: u} = r, f = c.size, g = f / 2;
            let p;
            this.drawTitle(), s.textAlign = h.textAlign("left"), s.textBaseline = "middle", s.lineWidth = .5, s.font = c.string;
            const {boxWidth: m, boxHeight: x, itemHeight: b} = ko(r, f), _ = this.isHorizontal(),
            ...
            this.legendItems.forEach(((w, M) => {
                ...
                !function (t, e, i) {
                    ...
                    if (s.fillStyle = K(i.fillStyle, l), s.lineCap = K(i.lineCap, "butt"), s.lineDashOffset = K(i.lineDashOffset, 0), s.lineJoin = K(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = K(i.strokeStyle, l), s.setLineDash(K(i.lineDash, [])), r.usePointStyle) {
                        ...
                        const o = e + Math.max((f - x) / 2, 0), a = h.leftForLtr(t, m), r = Be(i.borderRadius);
                        s.beginPath(), Object.values(r).some((t => 0 !== t)) ? ne(s, {
                            x: a,
                            y: o,
                            w: m,
                            h: x,
                    ...
                    ie(s, i.text, t, e + b / 2, c, {strikethrough: i.hidden, textAlign: h.textAlign(i.textAlign)})
                }(h.x(D), C, w), _ ? p.x += P + u : p.y += v
            })), Ei(this.ctx, t.textDirection)
        }

        drawTitle() {
            const t = this.options, e = t.title, i = We(e.font), o = Ve(e.padding);
            if (!e.display) return;
            const a = Li(t.rtl, this.left, this.width), r = this.ctx, l = e.position, h = i.size / 2, c = o.top + h;
            ...
            const g = n(l, u, u + f);
            r.textAlign = a.textAlign(s(l)), r.textBaseline = "middle", r.strokeStyle = e.color, r.fillStyle = e.color, r.font = i.string, ie(r, e.text, g, d, i)
        }

        _computeTitleHeight() {
            const t = this.options.title, e = We(t.font), i = Ve(t.padding);
            return t.display ? e.lineHeight + i.height : 0
        }

        _getLegendItemAt(t, e) {
            let i, s, n;
            if ($t(t, this.left, this.right) && $t(e, this.top, this.bottom)) for (n = this.legendHitBoxes, i = 0; i < n.length; ++i) if (s = n[i], $t(t, s.left, s.left + s.width) && $t(e, s.top, s.top + s.height)) return this.legendItems[i];
            return null
        }
        ...
        defaults: {
            ...
            labels: {
                color: t => t.chart.options.color, boxWidth: 40, padding: 10, generateLabels(t) {
                    const e = t.data.datasets, {labels: {usePointStyle: i, pointStyle: s, textAlign: n, color: o}} = t.legend.options;
                    return t._getSortedDatasetMetas().map((t => {
                        const a = t.controller.getStyle(i ? 0 : void 0), r = Ve(a.borderWidth);
                        return {
    ...
    class Do extends Ss {
        ...
        draw() {
            ...
            if (!e.display) return;
            const i = We(e.font),
                n = i.lineHeight / 2 + this._padding.top, {titleX: o, titleY: a, maxWidth: r, rotation: l} = this._drawArgs(n);
            ie(t, e.text, 0, 0, i, {
                color: e.color,
                maxWidth: r,
                rotation: l,
    ...
    function Eo(t, e) {
        const {element: i, datasetIndex: s, index: n} = e,
            o = t.getDatasetMeta(s).controller, {label: a, value: r} = o.getLabelAndValue(n);
        return {
            chart: t,
            label: a,
    ...
    function Io(t, e) {
        const i = t._chart.ctx, {body: s, footer: n, title: o} = t, {boxWidth: a, boxHeight: r} = e, l = We(e.bodyFont),
            h = We(e.titleFont), c = We(e.footerFont), d = o.length, u = n.length, f = s.length, g = Ve(e.padding);
        ...
        })), b = 0, i.font = c.string, J(t.footer, _), i.restore(), m += g.width, {width: m, height: p}
    }
    ...
    function Bo(t, e, i, s) {
        const {caretSize: n, caretPadding: o, cornerRadius: a} = t, {xAlign: r, yAlign: l} = i,
            h = n + o, {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = Be(a);
        let g = function (t, e) {
            let {x: i, width: s} = t;
    ...
    class Ho extends Ss {
        ...
        _resolveAnimations() {
            ...
            if (t) return t;
            const e = this._chart, i = this.options.setContext(this.getContext()),
                s = i.enabled && e.options.animation && i.animations, n = new us(this._chart, s);
            return s._cacheable && (this._cachedAnimations = Object.freeze(n)), n
        }

        getContext() {
            return this.$context || (this.$context = (t = this._chart.getContext(), e = this, i = this._tooltipItems, je(t, {
                tooltip: e,
                tooltipItems: i,
                type: "tooltip"
            })));
        ...
        getBody(t, e) {
            ...
            return J(t, (t => {
                const e = {before: [], lines: [], after: []}, n = No(i, t);
                Lo(e.before, Ro(n.beforeLabel.call(this, t))), Lo(e.lines, n.label.call(this, t)), Lo(e.after, Ro(n.afterLabel.call(this, t))), s.push(e)
            })), s
        }
        ...
        _createItems(t) {
            const e = this._active, i = this._chart.data, s = [], n = [], o = [];
            let a, r, l = [];
        ...
        update(t, e) {
            ...
            if (s.length) {
                ...
                const e = this._size = Io(this, i), a = Object.assign({}, t, e), r = Fo(this._chart, i, a),
        ...
        getCaretPosition(t, e, i) {
            const {xAlign: s, yAlign: n} = this, {caretSize: o, cornerRadius: a} = i, {topLeft: r, topRight: l, bottomLeft: h, bottomRight: c} = Be(a), {x: d, y: u} = t, {width: f, height: g} = e;
            let p, m, x, b, _, y;
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Vo(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = We(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a)
            }
        }

        _drawColorBox(t, e, i, s, n) {
            const o = this.labelColors[i], a = this.labelPointStyles[i], {boxHeight: r, boxWidth: l, boxPadding: h} = n,
                c = We(n.bodyFont), d = Vo(this, "left", n), u = s.x(d),
            ...
            if (n.usePointStyle) {
                ...
                t.strokeStyle = n.multiKeyBackground, t.fillStyle = n.multiKeyBackground, Gt(t, e, i, h), t.strokeStyle = o.borderColor, t.fillStyle = o.backgroundColor, Gt(t, e, i, h)
            } else {
                t.lineWidth = o.borderWidth || 1, t.strokeStyle = o.borderColor, t.setLineDash(o.borderDash || []), t.lineDashOffset = o.borderDashOffset || 0;
                const e = s.leftForLtr(u, l - h), i = s.leftForLtr(s.xPlus(u, 1), l - h - 2), a = Be(o.borderRadius);
                Object.values(a).some((t => 0 !== t)) ? (t.beginPath(), t.fillStyle = n.multiKeyBackground, ne(t, {
                    x: e,
                    y: g,
                    w: l,
                    h: r,
                    radius: a
                }), t.fill(), t.stroke(), t.fillStyle = o.backgroundColor, t.beginPath(), ne(t, {
                    x: i,
                    y: g + 1,
                    w: l - 2,
                    h: r - 2,
        ...
        drawBody(t, e, i) {
            const {body: s} = this, {bodySpacing: n, bodyAlign: o, displayColors: a, boxHeight: r, boxWidth: l, boxPadding: h} = i,
                c = We(i.bodyFont);
            let d = c.lineHeight, u = 0;
            const f = Li(i.rtl, this.x, this.width), g = function (i) {
                e.fillText(i, f.x(t.x + u), t.y + d / 2), t.y += d + n
            }, p = f.textAlign(o);
            let m, x, b, _, y, v, w;
            for (e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = Vo(this, p, i), e.fillStyle = i.bodyColor, J(this.beforeBody, g), u = a && "right" !== p ? "center" === o ? l / 2 + h : l + 2 + h : 0, _ = 0, v = s.length; _ < v; ++_) {
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Vo(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = We(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing
            }
        }

        drawBackground(t, e, i, s) {
            const {xAlign: n, yAlign: o} = this, {x: a, y: r} = t, {width: l, height: h} = i, {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = Be(s.cornerRadius);
        ...
        _updateAnimationTarget(t) {
            const e = this._chart, i = this.$animations, s = i && i.x, n = i && i.y;
            if (s || n) {
                const i = To[t.position].call(this, this._active, this._eventPosition);
                if (!i) return;
                const o = this._size = Io(this, t), a = Object.assign({}, i, this._size), r = Fo(e, t, a),
                    l = Bo(t, a, r, e);
        ...
        draw(t) {
            ...
            e.enabled && a && (t.save(), t.globalAlpha = i, this.drawBackground(n, t, s, e), Ri(t, e.textDirection), n.y += o.top, this.drawTitle(n, t, e), this.drawBody(n, t, e), this.drawFooter(n, t, e), Ei(t, e.textDirection), t.restore())
        }
        ...
        handleEvent(t, e) {
            const i = this.options, s = this._active || [];
            let n = !1, o = [];
        ...
        _positionChanged(t, e) {
            const {caretX: i, caretY: s, options: n} = this, o = To[n.position].call(this, t, e);
    ...
    class Uo extends zs {
        ...
        parse(t, e) {
            ...
            return ((t, e) => null === t ? null : Ht(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : Yo(i, t, K(e, t), this._addedLabels), i.length - 1)
        }
    ...
    function Xo(t, e, {horizontal: i, minRotation: s}) {
        const n = Et(s), o = (i ? Math.sin(n) : Math.cos(n)) || .001, a = .75 * e * ("" + t).length;
        return Math.min(e / o, a)
    }

    Uo.id = "category", Uo.defaults = {ticks: {callback: Uo.prototype.getLabelForValue}};
    ...
    class qo extends zs {
        ...
        buildTicks() {
            ...
            const s = function (t, e) {
                const i = [], {bounds: s, step: n, min: o, max: a, precision: r, count: l, maxTicks: h, maxDigits: c, includeBounds: d} = t,
                    u = n || 1, f = h - 1, {min: g, max: p} = e, m = !$(o), x = !$(a), b = !$(l), _ = (p - g) / (c + 1);
                ...
                let P = 0;
                for (m && (d && v !== o ? (i.push({value: o}), v < o && P++, Tt(Math.round((v + P * k) * y) / y, o, Xo(o, _, t)) && P++) : v < o && P++); P < M; ++P) i.push({value: Math.round((v + P * k) * y) / y});
                return x && d && w !== a ? i.length && Tt(i[i.length - 1].value, a, Xo(a, _, t)) ? i[i.length - 1].value = a : i.push({value: a}) : x && w !== a || i.push({value: w}), i
            }({
                maxTicks: i,
                bounds: t.bounds,
                min: t.min,
    ...
    class Ko extends qo {
        ...
        computeTickLimit() {
            const t = this.isHorizontal(), e = t ? this.width : this.height, i = Et(this.options.ticks.minRotation),
    ...
    Ko.id = "linear", Ko.defaults = {ticks: {callback: Ds.formatters.numeric}};
    ...
    class Zo extends zs {
        ...
        handleTickRangeOptions() {
            ...
            const n = e => i = t ? i : e, o = t => s = e ? s : t, a = (t, e) => Math.pow(10, Math.floor(Pt(t)) + e);
        ...
        buildTicks() {
            const t = this.options, e = function (t, e) {
                const i = Math.floor(Pt(e.max)), s = Math.ceil(e.max / Math.pow(10, i)), n = [];
                let o = q(t.min, Math.pow(10, Math.floor(Pt(e.min)))), a = Math.floor(Pt(o)),
    ...
    function ta(t) {
        const e = {l: 0, r: t.width, t: 0, b: t.height - t.paddingTop}, i = {}, s = [], n = [],
            o = t.getLabels().length;
        for (let h = 0; h < o; h++) {
            const o = t.options.pointLabels.setContext(t.getPointLabelContext(h));
            n[h] = o.padding;
            const c = t.getPointPosition(h, t.drawingArea + n[h]), d = We(o.font),
                u = (a = t.ctx, r = d, l = Y(l = t._pointLabels[h]) ? l : [l], {
                    w: Xt(a, r.string, l),
                    h: l.length * r.lineHeight
                });
            s[h] = u;
            const f = t.getIndexAngle(h), g = It(f), p = Jo(g, c.x, u.w, 0, 180), m = Jo(g, c.y, u.h, 90, 270);
        ...
        t._setReductions(t.drawingArea, e, i), t._pointLabelItems = function (t, e, i) {
            const s = [], n = t.getLabels().length, o = t.options, a = Qo(o),
                r = t.getDistanceFromCenterForValue(o.ticks.reverse ? t.min : t.max);
            for (let o = 0; o < n; o++) {
                const n = 0 === o ? a / 2 : 0, l = t.getPointPosition(o, r + n + i[o]), h = It(t.getIndexAngle(o)),
                    c = e[o], d = sa(l.y, c.h, h), u = ea(h), f = ia(l.x, c.w, u);
    ...
    function na(t, e, i, s) {
        const {ctx: n} = t;
        if (i) n.arc(t.xCenter, t.yCenter, e, 0, _t); else {
    ...
    Zo.id = "logarithmic", Zo.defaults = {ticks: {callback: Ds.formatters.logarithmic, major: {enabled: !0}}};
    ...
    class aa extends qo {
        ...
        setDimensions() {
            this.width = this.maxWidth, this.height = this.maxHeight, this.paddingTop = Qo(this.options) / 2, this.xCenter = Math.floor(this.width / 2), this.yCenter = Math.floor((this.height - this.paddingTop) / 2), this.drawingArea = Math.min(this.height - this.paddingTop, this.width) / 2
        }
        ...
        fit() {
            const t = this.options;
            t.display && t.pointLabels.display ? ta(this) : this.setCenterPoint(0, 0, 0, 0)
        }

        _setReductions(t, e, i) {
            let s = e.l / Math.sin(i.l), n = Math.max(e.r - this.width, 0) / Math.sin(i.r), o = -e.t / Math.cos(i.t),
                a = -Math.max(e.b - (this.height - this.paddingTop), 0) / Math.cos(i.b);
            s = oa(s), n = oa(n), o = oa(o), a = oa(a), this.drawingArea = Math.max(t / 2, Math.min(Math.floor(t - (s + n) / 2), Math.floor(t - (o + a) / 2))), this.setCenterPoint(s, n, o, a)
        }

        setCenterPoint(t, e, i, s) {
            const n = this.width - e - this.drawingArea, o = t + this.drawingArea, a = i + this.drawingArea,
        ...
        drawBackground() {
            ...
            if (t) {
                const i = this.ctx;
                i.save(), i.beginPath(), na(this, this.getDistanceFromCenterForValue(this._endValue), e, this.getLabels().length), i.closePath(), i.fillStyle = t, i.fill(), i.restore()
            }
        }

        drawGrid() {
            const t = this.ctx, e = this.options, {angleLines: i, grid: s} = e, n = this.getLabels().length;
            let o, a, r;
            if (e.pointLabels.display && function (t, e) {
                const {ctx: i, options: {pointLabels: s}} = t;
                for (let n = e - 1; n >= 0; n--) {
                    const e = s.setContext(t.getPointLabelContext(n)),
                        o = We(e.font), {x: a, y: r, textAlign: l, left: h, top: c, right: d, bottom: u} = t._pointLabelItems[n], {backdropColor: f} = e;
                    if (!$(f)) {
                        const t = Ve(e.backdropPadding);
                ...
                if (0 !== e) {
                    ...
                    !function (t, e, i, s) {
                        ...
                        !o && !s || !a || !r || i < 0 || (n.save(), n.strokeStyle = a, n.lineWidth = r, n.setLineDash(e.borderDash), n.lineDashOffset = e.borderDashOffset, n.beginPath(), na(t, i, o, s), n.closePath(), n.stroke(), n.restore())
        ...
        drawLabels() {
            ...
            t.save(), t.translate(this.xCenter, this.yCenter), t.rotate(s), t.textAlign = "center", t.textBaseline = "middle", this.ticks.forEach(((s, a) => {
                ...
                const r = i.setContext(this.getContext(a)), l = We(r.font);
    ...
    aa.id = "radialLinear", aa.defaults = {
        display: !0,
        animate: !0,
        position: "chartArea",
    ...
    function da(t, e, i, s) {
        ...
        for (let o = la.indexOf(t); o < n - 1; ++o) {
            const t = ra[la[o]], n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
    ...
    class ga extends zs {
        ...
        init(t, e) {
            const i = t.time || (t.time = {}), s = this._adapter = new gn._date(t.adapters.date);
        ...
        buildTicks() {
            ...
            const n = this.min, o = le(s, n, this.max);
            return this._unit = e.unit || (i.autoSkip ? da(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function (t, e, i, s, n) {
                for (let o = la.length - 1; o >= la.indexOf(i); o--) {
                    const i = la[o];
                    if (ra[i].common && t._adapter.diff(n, s, i) >= e - 1) return i
                }
                ...
                for (let e = la.indexOf(t) + 1, i = la.length; e < i; ++e) if (ra[la[e]].common) return la[e]
            }(this._unit) : void 0, this.initOffsets(s), t.reverse && o.reverse(), fa(this, o, this._majorUnit)
        }
        ...
        _generate() {
            const t = this._adapter, e = this.min, i = this.max, s = this.options, n = s.time,
                o = n.unit || da(n.minUnit, e, i, this._getLabelCapacity(e)), a = K(n.stepSize, 1),
                r = "week" === o && n.isoWeekday, l = At(r) || !0 === r, h = {};
            let c, d, u = e;
            ...
            return c !== i && "ticks" !== s.bounds && 1 !== d || ua(h, c, f), Object.keys(h).sort(((t, e) => t - e)).map((t => +t))
        }
        ...
        _getLabelSize(t) {
            const e = this.options.ticks, i = this.ctx.measureText(t).width,
                s = Et(this.isHorizontal() ? e.maxRotation : e.minRotation), n = Math.cos(s), o = Math.sin(s),
        ...
        _getLabelCapacity(t) {
            const e = this.options.time, i = e.displayFormats, s = i[e.unit] || i.millisecond,
                n = this._tickFormatFunction(t, 0, fa(this, [t], this._majorUnit), s), o = this._getLabelSize(n),
    ...
    function pa(t, e, i) {
        ...
        i ? (e >= t[r].pos && e <= t[l].pos && ({lo: r, hi: l} = ae(t, "pos", e)), ({pos: s, time: o} = t[r]), ({
            pos: n,
            time: a
        } = t[l])) : (e >= t[r].time && e <= t[l].time && ({lo: r, hi: l} = ae(t, "time", e)), ({
            time: s,
            pos: o
    ...
    class ma extends ga {
        ...
        initOffsets() {
            ...
            this._minPos = pa(e, this.min), this._tableRange = pa(e, this.max) - this._minPos, super.initOffsets(t)
        }
    ...
    return hn.register(Tn, xa, io, $o), hn.helpers = {...ji}, hn._adapters = gn, hn.Animation = cs, hn.Animations = us, hn.animator = a, hn.controllers = Bs.controllers.items, hn.DatasetController = ks, hn.Element = Ss, hn.elements = io, hn.Interaction = Le, hn.layouts = ii, hn.platforms = rs, hn.Scale = zs, hn.Ticks = Ds, Object.assign(hn, Tn, xa, io, $o, rs), hn.Chart = hn, "undefined" != typeof window && (window.Chart = hn), hn
}));